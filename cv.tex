...
\newcommand{\eduwork}[6][0.5em]{%
  ...
  \cvitem[#1]{#2\ifx&#3&\else--#3\fi}{#4. \color{color2} #5.%
    \ifx&#6&%
...
{Monte Carlo simulation, simulated annealing, genetic algorithms, nonlinear
  fitting, numerical linear algebra, error analysis}
